          ...
          <div class="container-fluid">
              <div class="row page-titles">
                  <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Minhas perguntas</h4>
                  </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle" style="text-align: center">
                                                <a href="show-answers?id={{$questions->id}}" data-toggle="tooltip" title="Mostre a resposta detalhada" data-id={{$questions->id}}><i class="fas fa-eye text-success"></i> </a>
                                                <a href="javascript:;" data-toggle="tooltip" title="Remover uma pergunta" data-id={{$questions->id}} onclick="RemoveQuestion(this)"> <i class="fas fa-trash text-primary"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
