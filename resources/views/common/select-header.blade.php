        ...
        <div class="navbar-header" style="background: rgb(1 192 200);">
            <a class="navbar-brand" href="/">
                ...
                <!-- Logo text --><span class="hidden-sm-down">
                    ...
                    <!-- Light Logo text -->
                    <img src="/assets/images/qa-logo.png" class="light-logo qa-logo" alt="homepage" />
                </span>
            </a>
        </div>

        <a class="navbar-brand nav-link header-back"><i class="fas fa-long-arrow-alt-left"></i> Voltar</a>
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0" style="align-items: center;">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"> <i class="far fa-question-circle"></i>
                            ...
                            <li>
                                <div class="message-center">
                                    ...
                                    <a href="/solution?id={{ $question->Subjects_List->id }}">
                                        ...
                                        <div class="mail-contnet">
                                            <h5 class="mail-desc">{{ $question->q_title }}</h5> <span
                                                class="mail-desc">{{ $question->question }}</span> <span
                                                class="time">{{ $question->updated_at }}</span>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
            ...
            <li class="nav-item dropdown u-pro">
                ...
                <div class="dropdown-menu dropdown-menu-right animated flipInY">
                    ...
                    <!-- text-->
                    <a href="{{ route('account-setting') }}" class="dropdown-item"><i
                            class="ti-settings mr-1"></i>Configurações de conta</a>
                    <!-- text-->
                    <div class="dropdown-divider"></div>
                    <!-- text-->
                    <a href="{{ route('logout') }}" class="dropdown-item"><i
                            class="fa fa-power-off mr-1"></i>Sistema de logout</a>
                    <!-- text-->
                </div>
            </li>
        </ul>
