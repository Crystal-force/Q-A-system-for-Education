                                  ...
                                  <tbody>
                                      ...
                                      <tr class="each-question">
                                          ...
                                          <td class="align-middle">
                                             ...
                                             @else
                                                <a href="javascript:;" data-toggle="modal" data-target="#AnswerListModal" data-whatever="reply" data-id="{{$question->Answers_List[0]->q_id}}" onclick="Answers(this)"><i class="fas fa-eye text-success"></i> </a>
                                             @endif
                                          </td>
                                      </tr>
                                      @endforeach
                                  ...
                                  <tbody>
                                      ...
                                      <tr class="each-question">
                                          ...
                                          <td class="align-middle">
                                            <div class="row">
                                                <div class="col-4">
                                                    <a href="javascript:;" data-toggle="modal" data-target="#replyAnswerModal" data-whatever="reply" data-id="{{$Answers->id}}" onclick="DetailAnswers(this)"><i class="fas fa-eye text-success"></i> </a>
                                                </div>
                                                
                                                <div class="col-4">
                                                    <a href="javascript:;" data-toggle="tooltip" title="Remover uma pergunta" data-id="{{$Answers->id}}" onclick="RemoveAnswers(this)"> <i class="fas fa-trash text-primary"></i></a>
                                                </div>
